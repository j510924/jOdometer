 ...
 * heightNumber: The height that each number needs // Default: 80
 * widthNumber: Width of the numbers' image // Default: 45
...
(function ($) {
    $.fn.jOdometer = function (settings) {
        ...
        function advanceCounter(newCounter) {
            ...
            if (settings.counterEnd && counter >= settings.counterEnd) {
                clearInterval(counterInterval);
...
// default settings
    $.fn.jOdometer.defaults = {
        ...
        speed: 500,
        easing: 'swing',
        numbersImage: '/image/jodometer.png',
        formatNumber: true,
        heightNumber: 80,
        widthNumber: 45,
        offsetRight: 0,
